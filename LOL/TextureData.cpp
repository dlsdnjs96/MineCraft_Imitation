...
TextureData::TextureData()
{
	...
	blockUV[BlockType::SAND][BLOCK_FACE_FORWARD]			= { 1.f / 16.f, 1.f / 16.f };
	...
	blockUV[BlockType::FURNACE][BLOCK_FACE_UP]					= { 14.f / 16.f, 32.f / 16.f };
	blockUV[BlockType::FURNACE][BLOCK_FACE_DOWN]				= { 14.f / 16.f, 32.f / 16.f };
	...
	blockUV[BlockType::BURNING_FURNACE][BLOCK_FACE_UP]					= { 14.f / 16.f, 32.f / 16.f };
	blockUV[BlockType::BURNING_FURNACE][BLOCK_FACE_DOWN]				= { 14.f / 16.f, 32.f / 16.f };
	...
	blockUV[BlockType::PUMPKIN][BLOCK_FACE_UP]						= { 6.f / 16.f, 7.f / 16.f };
	blockUV[BlockType::PUMPKIN][BLOCK_FACE_DOWN]					= { 6.f / 16.f, 7.f / 16.f };
	blockUV[BlockType::PUMPKIN][BLOCK_FACE_RIGHT]					= { 6.f / 16.f, 8.f / 16.f };
	blockUV[BlockType::PUMPKIN][BLOCK_FACE_LEFT]					= { 6.f / 16.f, 8.f / 16.f };
	blockUV[BlockType::PUMPKIN][BLOCK_FACE_FORWARD]					= { 6.f / 16.f, 8.f / 16.f };
	blockUV[BlockType::PUMPKIN][BLOCK_FACE_BEHIND]					= { 6.f / 16.f, 8.f / 16.f };


	blockUV[BlockType::PUMPKIN_CARVED][BLOCK_FACE_UP]					= { 6.f / 16.f, 7.f / 16.f };
	blockUV[BlockType::PUMPKIN_CARVED][BLOCK_FACE_DOWN]					= { 6.f / 16.f, 7.f / 16.f };
	blockUV[BlockType::PUMPKIN_CARVED][BLOCK_FACE_RIGHT]				= { 6.f / 16.f, 8.f / 16.f };
	blockUV[BlockType::PUMPKIN_CARVED][BLOCK_FACE_LEFT]					= { 6.f / 16.f, 8.f / 16.f };
	blockUV[BlockType::PUMPKIN_CARVED][BLOCK_FACE_FORWARD]				= { 7.f / 16.f, 8.f / 16.f };
	blockUV[BlockType::PUMPKIN_CARVED][BLOCK_FACE_BEHIND]				= { 6.f / 16.f, 8.f / 16.f };
	...
	blockUV[BlockType::JUNGLE_WOOD][BLOCK_FACE_RIGHT]				= { 5.f / 16.f, 5.f / 16.f };
	blockUV[BlockType::JUNGLE_WOOD][BLOCK_FACE_LEFT]				= { 5.f / 16.f, 5.f / 16.f };
	blockUV[BlockType::JUNGLE_WOOD][BLOCK_FACE_FORWARD]				= { 5.f / 16.f, 5.f / 16.f };
	blockUV[BlockType::JUNGLE_WOOD][BLOCK_FACE_BEHIND]				= { 5.f / 16.f, 5.f / 16.f };
	...
	blockUV[BlockType::BIRCH_WOOD][BLOCK_FACE_RIGHT]				= { 5.f / 16.f, 6.f / 16.f };
	blockUV[BlockType::BIRCH_WOOD][BLOCK_FACE_LEFT]					= { 5.f / 16.f, 6.f / 16.f };
	blockUV[BlockType::BIRCH_WOOD][BLOCK_FACE_FORWARD]				= { 5.f / 16.f, 6.f / 16.f };
	blockUV[BlockType::BIRCH_WOOD][BLOCK_FACE_BEHIND]				= { 5.f / 16.f, 6.f / 16.f };
